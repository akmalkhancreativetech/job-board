    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-12 mx-auto">
            <div class="mb-12 flex items-center">
                <h2 class="text-2xl font-medium text-gray-900 px-4">Your Listings ({{ $listings->count() }})</h2>
                ...
                @foreach($listings as $listing)
                    ...
                    >
                        ...
                        <span class="md:flex-grow flex flex-col items-end justify-center">
                            ...
                            <span><strong class="text-3xl font-bold">{{ $listing->clicks()->count() }}</strong> Apply Button Clicks</span>
                        </span>
                    </a>
                @endforeach
            </div>
