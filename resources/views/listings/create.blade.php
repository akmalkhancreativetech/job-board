<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            <div class="mb-4">
                <h2 class="text-2xl font-medium text-gray-900">Create a new listing ($99)</h2>
            </div>
            @if($errors->any())
            ...
            <form action="{{ route('listings.store') }}" id="payment_form" method="post" enctype="multipart/form-data" class="bg-gray-100 p-4">
                ...
                <div class="mb-4 mx-2">
                    ...
                    <x-input class="block mt-1 w-full" id="title" type="text" name="title" required />
                </div>
                <div class="mb-4 mx-2">
                    <x-label for="company" value="Company Name" />
                    <x-input class="block mt-1 w-full" id="company" type="text" name="company" required />
                </div>
                <div class="mb-4 mx-2">
                    <x-label for="logo" value="Company Logo" />
                    <x-input class="block mt-1 w-full" id="logo" type="file" name="logo" />
                </div>
                <div class="mb-4 mx-2">
                    <x-label for="location" value="Location (e.g. Remote, Unites States)" />
                    <x-input class="block mt-1 w-full" id="location" type="text" name="location" required />
                </div>
                <div class="mb-4 mx-2">
                ...
                <div class="mb-4 mx-2">
                    ...
                    <x-input class="block mt-1 w-full" id="tags" type="text" name="tags" />
                </div>
                <div class="mb-4 mx-2">
                ...
                <div class="mb-4 mx-2">
                    <label for="is_highlighted" class="inline-flex items-center font-medium text-sm text-gray-700">
                        <input type="checkbox" name="is_highlighted" id="is_highlighted" value="Yes"
